...
export default function Profile() {
    ...
    return (
        <div className="h-full w-full flex flex-row gap-4 p-10 bg-white">
            <div className="w-[300px] flex flex-col items-center gap-4 p-5 shadow-xl rounded-md">
                <img src="https://placehold.co/200x200" className="rounded-full border-black border-[1.5px]" />
                <div className="text-2xl font-semibold">
                    {data.firstName} {data.lastName}
                </div>
            </div>
            <div className="h-full bg-gray-200 w-[2px] rounded"></div>
            <div className="flex flex-col flex-1 gap-2">
                <div className="flex flex-col gap-12 shadow-lg py-5 px-3 rounded">
