        ...
        <div className="fixed inset-0 z-10 bg-black bg-opacity-50">
            <div className="fixed z-20 flex flex-col  inset-0 px-6 overflow-y-hidden text-white font-semibold bg-white w-1/2 h-1/2 self-center justify-self-center rounded">
                ...
                <div className="h-3/5 grid grid-cols-2 gap-x-8 gap-y-4 text-white text-xl font-semibold mt-10 py-4 px-1">
                    <div className="bg-slate-500 hover:bg-slate-400 p-2 px-4 rounded flex flex-row justify-between items-center cursor-pointer"><div>KWP</div><div>Strikeout wild pitch</div></div>
                    <div className="bg-slate-500 hover:bg-slate-400 p-2 px-4 rounded flex flex-row justify-between items-center cursor-pointer"><div>KPB</div><div>Strikeout pass ball</div></div>
                </div>
            </div>
        </div>);
}